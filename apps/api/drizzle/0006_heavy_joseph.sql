...
CREATE UNIQUE INDEX `games_user_id_external_id_unq` ON `games` (`user_id`,`external_id`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_platforms`("id", "user_id", "name", "external_id", "created_at") SELECT "id", "user_id", "name", "external_id", "created_at" FROM `platforms`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `platforms_user_id_name_unq` ON `platforms` (`user_id`,`name`);--> statement-breakpoint
CREATE UNIQUE INDEX `platforms_user_id_external_id_unq` ON `platforms` (`user_id`,`external_id`);